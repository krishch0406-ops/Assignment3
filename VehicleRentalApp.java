...
public class VehicleRentalApp {
    public static void main(String[] args) {
        ...
        // changed to use Singleton instead of new
        ...
        while (true) {
            ...
            switch (choice) {
                case 1:
                    ...
                    // changed to force uppercase for plate
                    ...
                    if (vehicle != null) {
                        try {
                            ...
                            System.out.println("Vehicle has been added successfully with plate: " + vehicle.getLicensePlate());
                        } catch (IllegalArgumentException error_msg) {
                            System.out.println("Error: " + error_msg.getMessage());
                            System.out.println("Vehicle was not added. ");
                        }
                    } else {
                        System.out.println("Vehicle was not added successfully. ");
                    }
                    break;
