...
public class RentalSystem {
    ...
    public static RentalSystem getInstance() {
        if (instance == null) {
            instance = new RentalSystem(); // create it if it doesn’t exist
        }
        return instance; // always return the same one
    }

    // fields (initialized inside constructor now)
    ...
    // same idea here, return boolean so I know if returning worked
